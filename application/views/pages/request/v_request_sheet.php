...
<div class="body">
    <div class="categories">
        <h2>Categories</h2>
        <!---on click, add products that match clicked category to request sheet--->
        ...
        <!--Form to add new category (only for admin)-->
        ...
        <div class="new-form">
            ...
            <div class="form-headings">
                ...
                <!--display all selected products, starts with empty sheet-->    
        ...
        <!---submit button for request form-->
